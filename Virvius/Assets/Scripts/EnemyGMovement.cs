...
public class EnemyGMovement : MonoBehaviour
{
    //=================================ScriptAssignment====================================//
    ...
    public enum EnemyState { idle, walk, chase, attack, damage, death, none }
    ...
    private void CheckDistance()
    {
        ...
        if (PlayerDistance() <= distanceRanges[2]) FoundPlayer();
            ...
            case EnemyState.attack:
                {
                    ...
                    //DIN STUFF------------------------------------->>>>
                    ////ATTACKID [ATTACK = 3] [JUMP = 4]
                    //int attackID = (distanceIndex == 0) ? 3 : 4;
                    //SetAnimation(attackID);
                    //movementSpeed = (distanceIndex == 0) ? movementSpeeds[1] : movementSpeeds[3];
                    //stoppingDistance = 12.2f;
                    //autoBraking = (distanceIndex == 0) ? true : false;
